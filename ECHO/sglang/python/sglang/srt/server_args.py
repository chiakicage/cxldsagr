...
class ServerArgs:
    ...
    def _handle_model_specific_adjustments(self):
        ...
        if is_deepseek_nsa(hf_config):
            if self.load_balance_method == "nsa_max_device":
                assert os.getenv("NSA_KV_OFFLOAD") is not None
...
class PortArgs:
    ...
    dp_controller_ipc_name: Optional[str] = None
    ...
    def init_new(
        ...
        if not server_args.enable_dp_attention:
            ...
            return PortArgs(
                ...
                tokenizer_worker_ipc_name=None,
                dp_controller_ipc_name=f"ipc://{tempfile.NamedTemporaryFile(delete=False).name}",
            )
