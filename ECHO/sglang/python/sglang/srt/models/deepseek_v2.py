...
class DeepseekV2ForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        if os.getenv("DS_DEBUG_LAYERS") is not None:
            self.config.num_hidden_layers = int(os.getenv("DS_DEBUG_LAYERS"))
                    ...
                    for mapping in expert_params_mapping:
                        ...
                        if fuse_qkv_a_proj and (
                            ...
                            if (
                                ...
                                ) and not isinstance(attn_quant_method, UnquantizedLinearMethod):
                                    cat_dim = 1
