"""NCU profiling script for NEW flash_mla_sm120 decode kernel (V32, h=128)."""
import argparse
import torch
import sys
sys.path.insert(0, '.')
...
# Profiled iteration
torch.cuda.nvtx.range_push("sparse_mla_decode_profile")
try:
    flash_mla_sm120.sparse_mla_decode_fwd(q, kv_packed, indices, sm_scale, d_v)
finally:
    torch.cuda.nvtx.range_pop()
torch.cuda.synchronize()
print(f"Done (new kernel, batch_size={batch_size}, heads={num_heads}, topk={topk})")
